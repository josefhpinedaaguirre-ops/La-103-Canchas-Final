...
// 1. Obtener el ID de la reserva y consultar su precio
if (isset($_GET['id'])) {
    $id_reserva_get = mysqli_real_escape_string($conexion, $_GET['id']);
    
    // TABLA EN MINÚSCULA: 'reservas'
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // TABLAS EN MINÚSCULA: 'pagos' y 'reservas'
...
<head>
    ...
    <style>
        ...
        h3 { color: #f1c40f; text-align: center; margin-top: 0; text-transform: uppercase; }
        ...
        .cancelar:hover { color: #e74c3c; }
    </style>
</head>
<body>
    <div class="pago-box">
        <h3>💰 Registrar Pago</h3>
        <p style="text-align: center; font-size: 12px; color: #888;">Reserva #<?php echo htmlspecialchars($id_reserva_get); ?></p>
        
        <form method="POST">
            <input type="hidden" name="id_reserva" value="<?php echo htmlspecialchars($id_reserva_get); ?>">
