...
// --- CONSULTA CORREGIDA CON TABLAS EN MINÚSCULA ---
...
<head>
    ...
    <style>
        ...
        table { width: 100%; border-collapse: collapse; background: #1a1a1a; border-radius: 10px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.5); }
        ...
        .btn-accion { padding: 8px 12px; text-decoration: none; border-radius: 5px; font-weight: bold; font-size: 11px; display: inline-block; transition: 0.3s; }
        .btn-confirmar { background: #f1c40f; color: black; }
        .btn-confirmar:hover { background: #d4ac0d; }
...
<body>
    ...
    <div class="header-info">
        <div>
            ...
            <p style="color: #888; margin: 5px 0 0 0;">Próximos partidos (Control de Canchas)</p>
        </div>
    ...
    <table>
        ...
        <tbody>
                ...
                <td>
                    ...
                    <?php elseif($res['estado_reserva'] == 'confirmada'): ?>
                        <a href="finalizar_reserva.php?id=<?php echo $res['id']; ?>" 
                           ...
                           onclick="return confirm('¿Confirmas que entregaron todo el equipo?')">
                           Finalizar Turno
                        </a>
                    <?php else: ?>
            ...
            <?php if(mysqli_num_rows($resultado) == 0): ?>
                <tr>
                    <td colspan="8" style="text-align: center; color: #888; padding: 40px;">No hay reservas programadas para hoy o días futuros.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
